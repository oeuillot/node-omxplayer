...
OMXPlayer.prototype.start = function(moviePath, callback) {
	...
	setTimeout(function waitSync() {
		...
		self.getIdentity(function(error, id) {
			...
			self._poolProperties(omxProperties);
...
OMXPlayer.prototype._poolProperties = function(omxProperties) {
	var self = this;
	var properties = self.properties;

	omxProperties = omxProperties || [ "Volume", "Position", "Duration", "PlaybackStatus" ];
